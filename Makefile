...
EXECUTION= access.c execution.c heredoc.c minishell_utils.c signal.c toggle_signal.c ft_utils.c
PARSING= parse.c sp_split.c split.c get_fd_i.c get_fd_o.c nodes.c get_var.c get_length.c sanitize.c split_utils.c
